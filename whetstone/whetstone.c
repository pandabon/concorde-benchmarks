...
*/
	...
	duration_sec = (float)(end_tv.tv_sec - start_tv.tv_sec)
		+ (float)(end_tv.tv_usec - start_tv.tv_usec) / 1000000.0f;
...
*/
	...
	printf("Loops: %ld, Iterations: %d, Duration: %.6f sec.\n",
			LOOP, II, (double)duration_sec);

	KIPS = (100.0f * LOOP * II) / duration_sec;
	if (KIPS >= 1000.0)
